                        ...
                        {allData.length > 0 &&
                            allData.map((dt, ind) => (
                                ...
                                >
                                    ...
                                    <td className="p-3 whitespace-nowrap tracking-wide text-sm text-gray-700 text-left">
                                        <span>{dt?.lat || 'Not Yet'}</span>
                                        <span className="ml-3">
                                            {compareDate(dt?.lat) ? (
                                                <span className="bg-teal-600 p-1 rounded text-white text-sm">
                                                    Available
                                                </span>
                                            ) : (
                                                <span className="bg-rose-600 p-1 rounded text-white text-sm">
                                                    Not Available
                                                </span>
                                            )}
                                        </span>
